class DivisionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @division.save
        format.html { redirect_to @division, notice: 'División creada correctamente.' }
  ...
  def update
    respond_to do |format|
      if @division.update(division_params)
        format.html { redirect_to @division, notice: 'División actualizada correctamente.' }
  ...
  def destroy
    @division.destroy
    respond_to do |format|
      format.html { redirect_to divisions_url, notice: 'División eliminada.' }
